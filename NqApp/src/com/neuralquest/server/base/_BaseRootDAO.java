...
public abstract class _BaseRootDAO {
	...
	protected final static ThreadLocal currentSession = new ThreadLocal();
	...
	public static void initialize () {
		com.neuralquest.server.dao._RootDAO.initialize(
			(String) null);
	}
	...
	public static void initialize (String configFileName) {
		com.neuralquest.server.dao._RootDAO.initialize(
			configFileName,
			com.neuralquest.server.dao._RootDAO.getNewConfiguration(
				null));
	}
	...
	public static void initialize (String configFileName, Configuration configuration) {
		if (null != sessionFactoryMap && null != sessionFactoryMap.get(configFileName)) return;
			...
			if (null == configFileName) {
				...
				com.neuralquest.server.dao._RootDAO.setSessionFactory(
					null,
